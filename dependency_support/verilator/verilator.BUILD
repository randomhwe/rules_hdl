...
genrule(
    ...
    cmd = """
    python3 $(location src/astgen) -I $$(dirname $(location src/astgen)) \
        --astdef V3AstNodeDType.h \
        --astdef V3AstNodeExpr.h \
        --astdef V3AstNodeOther.h \
...
genrule(
    ...
    cmd = """
        python3 $(location src/astgen) -I $$(dirname $(location src/V3Const.cpp)) \
            --astdef V3AstNodeDType.h \
            --astdef V3AstNodeExpr.h \
            --astdef V3AstNodeOther.h \
            --dfgdef V3DfgVertices.h \
...
cc_library(
    ...
    # TODO: Remove these once upstream fixes these warnings
    copts = ["-Wno-unused-const-variable", "-fcoroutines"],
    includes = ["include"],
    strip_include_prefix = "include/",
    textual_hdrs = [
